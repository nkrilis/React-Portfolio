                    ...
                    <div className="col-lg-4 me-auto">
                        ...
                        <ul className="list-group">
                            <li className="list-group-item bg-transparent text-white">
                                Java, Python, C++, C#, Javascript, CSS3, HTML, MySQL, MongoDB, REST APIs,
                            </li>
                            <li className="list-group-item bg-transparent text-white">
                                GraphQL, Express, React, Redux, Node JS, JQuery, Handlebars, Bootstrap, tailwind, Vue JS
                            </li>
                            <li className="list-group-item bg-transparent text-white">
                                MUI, Maven, Springboot, IBM MQ, Oauth 2.0, RHEL 8, GitHub, Bitbucket, Confluence, Heroku, MongoDB Atlas
                            </li>
                        </ul>
                    </div>
                </div>
                {/* <!-- About Section Button--> */}
                <div className="text-center mt-4 row-cols-12">
                    ...
                    <a className="btn btn-xl btn-outline-light m-4" href={require("./../files/Nicholas-Krilis-Resume-2022.pdf")} target="_blank" rel="noreferrer"><i className="fa-regular fa-file"></i>
                    <p>Resumé</p>
                    </a>
                </div>
            </div>
